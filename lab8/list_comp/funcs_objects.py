...
# Define a function called distance with parameters P1 and P2 and returns the distance between the two points
def distance(P1, P2):
    euclidDistance = sqrt(((P2.x-P1.x)**2) + ((P2.y-P1.y)**2))
    return euclidDistance

# Define a function called circles_overlap with parameters Circle1 and Circle2 and returns a boolean if the circles overlap
